...
export const aboutSliderData = [
  ...
  },
  {
    ...
    text: "Every Tuesday and Wednesday we party like it's Friday in the biggest nightclub in Pula – Pietas Julia. Now that we are corona-free, after two years we can finally get back to partying in the full sense of the word. With your Party boat ticket, get a free entry with a welcome drink.",
    imageSrc: "/about3.jpg"
  }
]
...
export const reviewData = [
  {
    name: "Ana Glibo",
    review: "I always go to every Boom event in nightclubs in Pula and it is always so fun and full of people but last year I event to the Boat party for the first time and it was AMAZINGG!! The atmosphere, people, music, … everything was  🔥  🔥  🔥",
    source: "Facebook"
  },
  {
    name: "Janine M",
    review: "Boat party was amazing, I went with my friends and we had so much fun. It is really unique and we couldn’t find similar party like that here in Istria. Prices are also great, just like the ones in the nightclubs in Pula.",
    source: "Facebook"
  },
  {
    name: "Dominic Hansel",
    review: "I can’t wait to go to another boat party by Boom next summer. I was there on 26/8/2021 and me and my friends had a blast. We were partying for 6 hours!!! DJ was great *_*",
    source: "Tripadvisor"
  },
  {
    name: "Luka Beljo",
    review: "This summer I went to 2 Boom boat parties and I don’t know which one was better. Everyone was crazyyy. We had so much fun that we are already planning to go again next summer. CANT WAIT!",
    source: "Tripadvisor"
  },
  {
    name: "Paula Pitner",
    review: "The best events in town! Great organization, themed parties, young people, crazy party boom boat and more. Boom organization really changed summer in Pula.  Prices are too damn good! 🥂 Everything is affordable. If you ever come to Pula and look for a great time just check BooM Events, you won't be disappointed! 🎉",
    source: "Google"
  },
  {
    name: "Ena Belani",
    review: "One of the best events I’ve ever been to! I highly recommend party boat, it’s such an amazing experience. Awesome DJs, people, booze, everything! I can’t wait to do it all again.",
    source: "Google"
  },
  {
    name: "Ena Belani",
