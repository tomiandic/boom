        ...
        <div className={classes.eventItineraryHolder}>
          <div className={`${classes.itineraryPart} ${classes.eventHeader}`}>
            ...
            <div className={classes.headerDetails}>
             <StaticImage width={15} src="../../static/icons/location.svg" />
              <p>{eventData.location}</p>
              <StaticImage width={15} src="../../static/icons/calendar.svg" />
              <p>{eventData.date}</p>
              <StaticImage width={15} src="../../static/icons/clock.svg" />
              <p>{eventData.time}</p>
            </div>
          </div>
          ...
          >
            ...
            <div className={classes.overviewGrid}>
              <div className={classes.overviewGridItem}>
                <StaticImage className={classes.overviewGridItemIcon} src="../../static/icons/bar.svg"></StaticImage>
                <p>{eventData.drinkShortText}</p>
              </div>
              <div className={classes.overviewGridItem}>
                <StaticImage className={classes.overviewGridItemIcon} src="../../static/icons/swimming.svg"></StaticImage>
                <p>{eventData.swimShortText}</p>
              </div>
              <div className={classes.overviewGridItem}>
                <StaticImage className={classes.overviewGridItemIcon} src="../../static/icons/island.svg"></StaticImage>
                <p>{eventData.islandShortText}</p>
              </div>
              <div className={classes.overviewGridItem}>
                <StaticImage className={classes.overviewGridItemIcon} src="../../static/icons/music.svg"></StaticImage>
                <p>{eventData.musicShortText}</p>
              </div>
            </div>
            <p className={classes.itineraryParagraph}>
             {eventData.overviewText}
            </p>
          </div>
          ...
          <div id="itinerary" className={`${classes.itineraryPart} ${classes.bookingRoute}`}>
            ...
            <VerticalTimeline layout="1-column-left" lineColor="#f1f2f3">
              {eventData.itinerary.map(slide => 
                <VerticalTimelineElement
                className="vertical-timeline-element--work"
                date={slide.time??null}
              >
                <h4 className="vertical-timeline-element-title">{slide.title}</h4>
               {slide.image? <img style={{marginTop: "1rem"}}
                  src={slide.image}
                />:null }
                <p className={classes.itineraryParagraph}>
                  {slide.text}
          ...
          <div id="tickets" className={`${classes.itineraryPart} ${classes.bookingRoute}`}>
            ...
            <div className={classes.ticketCategoryBox}>
              ...
              <div className={classes.ticketPrice}>
                ...
                <Link onClick={() => resetLocalStorage()} to="/event/booking" className={classes.bookTicketButton}>Book a Ticket</Link>
              </div>
            </div>
            <div className={classes.ticketCategoryBox}>
...
l101-122.8c2.1-3.1,4.2-7.3,4.2-12.5v-98.8C265.3,134.2,256,124.9,244.5,124.9z"/>
        ...
        <div className={classes.bookingDetails}>
          ...
          <Link onClick={() => resetLocalStorage()} to="/event/booking" className={classes.bookingButton}>Book Now</Link>
        </div>
      </div>
    </section>
  );
